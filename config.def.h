...
static uint32_t colors[][3]                = {
	/*               fg          bg          border    */
	[SchemeNorm] = { 0xe0dedaff, 0x1c2e36ff, 0x1c2e36ff },
	[SchemeSel]  = { 0xe0dedaff, 0x637c8cff, 0xe0dedaff },
	[SchemeUrg]  = { 0,          0,          0xeb6f92ff },
};
...
static const char *dmenucmd[] = { "bemenu-start", NULL };
